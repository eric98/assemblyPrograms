...
; NOT EXTENDED ASCCII CODES
    ASCII_UP_CONTROL_SCHEME_2       EQU 'w'
    ASCII_LEFT_CONTROL_SCHEME_2     EQU 'a'
    ASCII_DOWN_CONTROL_SCHEME_2     EQU 's'
    ASCII_RIGHT_CONTROL_SCHEME_2    EQU 'd'
...
; ASCII / ATTR CODES TO DRAW THE FIELD
    ...
    ASCII_BKG_FIELD EQU 020h
    ATTR_BKG_FIELD  EQU 010h
...
MAIN 	PROC 	NEAR
  ...
  MAIN_LOOP:
      ...
      CMP AL, ASCII_UP_CONTROL_SCHEME_2
      JZ UP_KEY
      CMP AL, ASCII_LEFT_CONTROL_SCHEME_2
      JZ LEFT_KEY
      CMP AL, ASCII_DOWN_CONTROL_SCHEME_2
      JZ DOWN_KEY
      CMP AL, ASCII_RIGHT_CONTROL_SCHEME_2
      JZ RIGHT_KEY
...
; ****************************************
; Draws the background field of the game
; Entry: 
; 
; Returns:
;   
...
;    left - top: (FIELD_R1, FIELD_C1) 
;    right - bottom: (FIELD_R2, FIELD_C2)
;   Character: ASCII_BKG_FIELD
;   Attribute: ATTR_BKG_FIELD
; Calls:
;   PRINT_CHAR_ATTR
; ****************************************
PUBLIC DRAW_BKG_FIELD
DRAW_BKG_FIELD PROC NEAR

    PUSH AX
    PUSH BX
    PUSH DX

    MOV AL, ASCII_BKG_FIELD
    MOV BL, ATTR_BKG_FIELD
...
DRAW_OBSTACLES PROC NEAR
    ...
    LEA SI, OBSTACLES_ROW   ; Move var pointer to register SI
    LEA DI, OBSTACLES_COL   ; Move var pointer to register DI
  DRAW_LOOP:
        MOV DH, [SI]        ; Get row (Y) coordinate for current obstacle
        MOV DL, [DI]        ; Get col (X) coordinate for current obstacle
        PUSH CX             ; Somebody modifies CX ... save it!
        CALL MOVE_CURSOR
        CALL PRINT_CHAR_ATTR   
        POP CX              ; Restore CX
        ...
        INC SI
        INC DI        
        LOOP DRAW_LOOP      ; More obstacles left? -> Loop!
...
DATA_SEG	SEGMENT	PUBLIC
    ...
    OBSTACLES_ROW DB 5,  7, 11, 13, 18,  8,  3,  3,  18, 2
    OBSTACLES_COL DB 3, 17, 23, 70, 72, 41, 45, 52, 55, 76
